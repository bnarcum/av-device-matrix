...
const VENDOR_FILTERS: readonly VendorFilter[] = ['all', ...VENDOR_ORDER]
...
export default function App() {
  ...
  const activeVendorTheme = vendor === 'all' ? null : VENDORS[vendor]

  useEffect(() => {
    const base = 'A/V Device Matrix · Logitech · Poly · Neat'
